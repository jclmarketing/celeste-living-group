...
$clg_linkedin         = get_option('clg_linkedin_url', 'https://uk.linkedin.com/company/celeste-living-group');
$clg_linkedin_label   = get_option('clg_linkedin_label', 'LinkedIn');
$clg_facebook         = get_option('clg_facebook_url', 'https://www.facebook.com/p/Celeste-Living-Group-61575384155989/');
