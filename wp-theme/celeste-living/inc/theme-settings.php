...
function clg_settings_fields() {
    return array(
        ...
        'clg_linkedin_url'     => array('LinkedIn URL', 'https://linkedin.com', 'text', 'Leave blank to hide'),
        'clg_linkedin_label'   => array('LinkedIn Link Label (footer)', 'LinkedIn', 'text'),
        'clg_facebook_url'     => array('Facebook URL', 'https://facebook.com', 'text', 'Leave blank to hide'),
